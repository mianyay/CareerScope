...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "CareerScope — career pathways for Australian students" },
      {
        name: "description",
        content:
          "Explore careers, take a career quiz, hear from real workers and connect with other students aged 15-18.",
      },
